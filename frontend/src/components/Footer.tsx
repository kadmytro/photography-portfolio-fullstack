...
function Footer() {
  ...
  return (
    <div
      className={`h-36 bg-footer text-footerText items-center content-center justify-items-center ${
        screenType === "wide" ? " flex justify-between" : ""
      }`}
    >
      {loading ? (
        <div></div>
      ...
      <div
        className="w-fit flex-1 py-2 h-fit text-center text-lg mx-auto"
        style={{ maxWidth: "90%" }}
      >
